 ...
 *  PROJECT     :       SAFNWC
 *  UNIT NAME   :       MSG
 *  FILE        :       msg_l15_AttitudeRecord.c
 *  TYPE        :       MSG Level1.5 Image Data library
 *
 *  FUNCTION    :       MSG Level1.5 AttitudeRecord I/O
 *
 ****************************************************************************
 * HISTORY
 *
...
/************************************************************
 * FUNCTION:     freadAttitudeRecord
 * DESCRIPTION:  Read a Attitude structure
 * DATA IN:      fp: file
 * DATA OUT:     r:  Attitude structure
 *************************************************************
 * HISTORY
 *
 *  DATE    VERSION  AUTHOR   REASONS
 ...
 *************************************************************/
void
freadAttitudeRecord(Attitude_Record *r, FILE *fp)
{
  fread(&r->ch,1,20420,fp);
}


/************************************************************
 * FUNCTION:     fwriteAttitudeRecord
 * DESCRIPTION:  Write a Attitude structure
 * DATA IN:      fp: file
 * DATA OUT:     r:  Attitude structure
 *************************************************************
 * HISTORY
 ...
 *************************************************************/
void
fwriteAttitudeRecord(Attitude_Record *r, FILE *fp)
{
  fwrite(&r->ch,1,20420,fp);
}
