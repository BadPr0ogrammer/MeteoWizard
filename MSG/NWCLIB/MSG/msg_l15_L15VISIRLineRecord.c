 ...
 *  PROJECT     :       SAFNWC
 *  UNIT NAME   :       MSG
 *  FILE        :       msg_l15_L15VISIRLineRecord.c
 *  TYPE        :       MSG Level1.5 Image Data library
 *
 *  FUNCTION    :       MSG Level1.5 L15VISIRLineRecord I/O
 *
 ****************************************************************************
 * HISTORY
 *
...
/************************************************************
 * FUNCTION:     freadL15VISIRLineRecord
 * DESCRIPTION:  Read a L15VISIRLine structure
 * DATA IN:      fp: file
 * DATA OUT:     r:  L15VISIRLine structure
 *************************************************************
 * HISTORY
 *
 *  DATE    VERSION  AUTHOR   REASONS
 ...
 *************************************************************/
void
freadL15VISIRLineRecord(L15VISIRLine_Record *r, FILE *fp)
{
  fread(&r->L15VISIRLineVersion,1,1,fp);
  freadLineSideInfoRecord(&r->LineSideInfo,fp);
  fread(&r->LineData,1,4640,fp);
}


/************************************************************
 * FUNCTION:     fwriteL15VISIRLineRecord
 * DESCRIPTION:  Write a L15VISIRLine structure
 * DATA IN:      fp: file
 * DATA OUT:     r:  L15VISIRLine structure
 *************************************************************
 * HISTORY
 ...
 *************************************************************/
void
fwriteL15VISIRLineRecord(L15VISIRLine_Record *r, FILE *fp)
{
  fwrite(&r->L15VISIRLineVersion,1,1,fp);
  fwriteLineSideInfoRecord(&r->LineSideInfo,fp);
  fwrite(&r->LineData,1,4640,fp);
}
