 ...
 *  PROJECT     :       SAFNWC
 *  UNIT NAME   :       MSG
 *  FILE        :       msg_l15_RPSummaryRecord.c
 *  TYPE        :       MSG Level1.5 Image Data library
 *
 *  FUNCTION    :       MSG Level1.5 RPSummaryRecord I/O
 *
 ****************************************************************************
 * HISTORY
 *
...
/************************************************************
 * FUNCTION:     freadRPSummaryRecord
 * DESCRIPTION:  Read a RPSummary structure
 * DATA IN:      fp: file
 * DATA OUT:     r:  RPSummary structure
 *************************************************************
 * HISTORY
 *
 *  DATE    VERSION  AUTHOR   REASONS
 ...
 *************************************************************/
void
freadRPSummaryRecord(RPSummary_Record *r, FILE *fp)
{
  fread(&r->ch,1,72,fp);
}
...
/************************************************************
 * FUNCTION:     fwriteRPSummaryRecord
 * DESCRIPTION:  Write a RPSummary structure
 * DATA IN:      fp: file
 * DATA OUT:     r:  RPSummary structure
 *************************************************************
 * HISTORY
 ...
 *************************************************************/
void
fwriteRPSummaryRecord(RPSummary_Record *r, FILE *fp)
{
  fwrite(&r->ch,1,72,fp);
}
