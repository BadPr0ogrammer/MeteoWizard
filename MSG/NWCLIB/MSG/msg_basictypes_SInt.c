 ...
 *  PROJECT     :       SAFNWC
 *  UNIT NAME   :       MSG
 *  FILE        :       msg_basictypes_SInt.c
 *  TYPE        :       MSG Level1.5 Image Data library
 *
 *  FUNCTION    :       MSG Basic Types SInt I/O
...
/*************************************************************
 * FUNCTION:     freadSInt
 * DESCRIPTION:  Read a signed int data (4 bytes)
 * DATA IN:      fp:     file
 *               nitems: no. of items to read
 * DATA OUT:     i:      signed int data
 *************************************************************
 * HISTORY
 *
 *  DATE    VERSION  AUTHOR   REASONS
 ...
 *************************************************************/
void
freadSInt(signed int *i, int nitems, FILE *fp)
{
...
/************************************************************
 * FUNCTION:     fwriteSInt
 * DESCRIPTION:  Write a signed int data (4 bytes)
 * DATA IN:      fp:     file
 ...
 *************************************************************/
void
fwriteSInt(signed int *i, int nitems, FILE *fp)
{
  //#define BIGENDIAN 0 /* Sun Work Station */
