 ...
 *  PROJECT     :       SAFNWC
 *  UNIT NAME   :       MSG
 *  FILE        :       msg_l15_MPEFCalFeedBack.c
 *  TYPE        :       MSG Level1.5 Image Data library
 *
 *  FUNCTION    :       MSG Level1.5 MPEFCalFeedBack I/O
 *
 ****************************************************************************
 * HISTORY
 *
...
/************************************************************
 * FUNCTION:     freadMPEFCalFeedBack
 * DESCRIPTION:  Read a MPEFCalFeedBack structure
 * DATA IN:      fp: file
 * DATA OUT:     r:  MPEFCalFeedBack structure
 *************************************************************
 * HISTORY
 *
 *  DATE    VERSION  AUTHOR   REASONS
 ...
 *************************************************************/
void
freadMPEFCalFeedBack(MPEFCalFeedBack *r, FILE *fp)
{
  fread(&r->ch,1,384,fp);
}
...
/************************************************************
 * FUNCTION:     fwriteMPEFCalFeedBack
 * DESCRIPTION:  Write a MPEFCalFeedBack structure
 * DATA IN:      fp: file
 * DATA OUT:     r:  MPEFCalFeedBack structure
 *************************************************************
 * HISTORY
 ...
 *************************************************************/
void
fwriteMPEFCalFeedBack(MPEFCalFeedBack *r, FILE *fp)
{
  fwrite(&r->ch,1,384,fp);
}
