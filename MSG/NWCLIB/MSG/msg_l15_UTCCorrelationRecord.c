 ...
 *  PROJECT     :       SAFNWC
 *  UNIT NAME   :       MSG
 *  FILE        :       msg_l15_UTCCorrelationRecord.c
 *  TYPE        :       MSG Level1.5 Image Data library
 *
 *  FUNCTION    :       MSG Level1.5 UTCCorrelationRecord I/O
 *
 ****************************************************************************
 * HISTORY
 *
...
/************************************************************
 * FUNCTION:     freadUTCCorrelationRecord
 * DESCRIPTION:  Read a UTCCorrelation structure
 * DATA IN:      fp: file
 * DATA OUT:     r:  UTCCorrelation structure
 *************************************************************
 * HISTORY
 *
 *  DATE    VERSION  AUTHOR   REASONS
 ...
 *************************************************************/
void
freadUTCCorrelationRecord(UTCCorrelation_Record *r, FILE *fp)
{
  fread(&r->ch,1,59,fp);
}
...
/************************************************************
 * FUNCTION:     fwriteUTCCorrelationRecord
 * DESCRIPTION:  Write a UTCCorrelation structure
 * DATA IN:      fp: file
 * DATA OUT:     r:  UTCCorrelation structure
 *************************************************************
 * HISTORY
 ...
 *************************************************************/
void
fwriteUTCCorrelationRecord(UTCCorrelation_Record *r, FILE *fp)
{
  fwrite(&r->ch,1,59,fp);
}
