 ...
 *  PROJECT     :       SAFNWC
 *  UNIT NAME   :       MSG
 *  FILE        :       msg_l15_EphemeridsRecord.c
 *  TYPE        :       MSG Level1.5 Image Data library
 *
 *  FUNCTION    :       MSG Level1.5 EphemeridsRecord I/O
 *
 ****************************************************************************
 * HISTORY
 *
...
/************************************************************
 * FUNCTION:     freadEphemeridsRecord
 * DESCRIPTION:  Read a Ephemerids structure
 * DATA IN:      fp: file
 * DATA OUT:     r:  Ephemerids record
 *************************************************************
 * HISTORY
 *
 *  DATE    VERSION  AUTHOR   REASONS
 ...
 *************************************************************/
void
freadEphemeridsRecord(Ephemerids_Record *r, FILE *fp)
{
  fread(&r->ch,1,326042,fp);
}


/************************************************************
 * FUNCTION:     fwriteEphemeridsRecord
 * DESCRIPTION:  Write a Ephemerids structure
 * DATA IN:      fp: file
 * DATA OUT:     r:  Ephemerids record
 *************************************************************
 * HISTORY
 ...
 *************************************************************/
void
fwriteEphemeridsRecord(Ephemerids_Record *r, FILE *fp)
{
  fwrite(&r->ch,1,326042,fp);
}
