...
namespace Util
{
	...
	inline std::string CMSGTime::FormatTime(std::string i_csFormat ) const
	{
		try
		{
            ...
            l_stringsize = GetTimeFormatA(LOCALE_SYSTEM_DEFAULT,
							  NULL,
							  &l_sNTTime,
							  i_csFormat.c_str(),
							 NULL,
            ...
            l_Ret = GetTimeFormatA(LOCALE_SYSTEM_DEFAULT,
							  NULL,
							  &l_sNTTime,
							  i_csFormat.c_str(),
	...
	inline std::string CMSGTime::FormatDate(std::string i_csFormat ) const
	{
		try
		{
            ...
            l_stringsize = GetDateFormatA(LOCALE_SYSTEM_DEFAULT,
							  NULL,
							  &l_sNTTime,
							  i_csFormat.c_str(),
							  NULL,
            ...
            l_Ret = GetDateFormatA(LOCALE_SYSTEM_DEFAULT,
							  NULL,
							  &l_sNTTime,
							  i_csFormat.c_str(),
							  &l_Buffer[0],
